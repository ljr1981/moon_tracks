note
	description: "[
		Representation of an effected {MT_OUTPUT_VIEW}.
		]"
...
note
	design_intent: "[
		This view has controls for whatever data is needed to
		show the user what has been generated by a "writer"
		(e.g. MT_CLASS_WRITER or MT_SETTER_WRITER).
]"
